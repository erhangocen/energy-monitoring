...
Energy Monitoring API - Sayaç okuma ve enerji tüketimi takip sistemi.

Bu proje, enerji sayaçlarının okumalarını takip etmek, tüketim analizleri yapmak ve raporlar oluşturmak için geliştirilmiş bir REST API'dir.
