...
import W3 from '@/assets/apollo-login.png';
import {
          ...
          <div className='relative flex hidden h-full flex-col justify-between bg-muted p-10 text-white dark:border-r lg:flex'>
            ...
            <div className='relative z-20'>
              <blockquote className='space-y-2'>
                <p className='text-lg'>
                  AI desteği ve akıllı içgörülerle güç kazanın. <br />{' '}
                  <div className='flex flex-row items-center gap-2'>
                    <div>
                      Enerji bilinci yüksek işletmeler için gerçek zamanlı
                      izleme ve sektörel kıyaslamalar ile enerji maliyetlerini
                      düşürün, verimliliğinizi artırın ve karbon salımınızı
